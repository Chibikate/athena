    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24 space-y-4">
      ...
      <div className="bg-gray-100 p-8 rounded-lg shadow-md">
        ...
        <div className="bg-gray-100 p-8 rounded-lg shadow-md">
          ...
          />
          <p className="mt-4 text-center">
            To separate the mandible, start by generating face groups. This will
            allow you to select most of the mandibles in the least amount of
            time. Click on the &ldquo;Edit&rdquo; button on the left toolbar to
