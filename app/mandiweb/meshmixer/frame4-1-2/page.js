    ...
    <main className="flex flex-row items-center text-center justify-between p-8 space-y-4">
      ...
      <div className="flex flex-col space-x-4 bg-[rgba(191,213,247,0.3)] p-4 rounded-lg shadow-md text-center">
        <div className="text-center mb-4">
          ...
          If clicking the eye icon will make the “accept” button for mirror function disappear, click again the <span className="font-bold">"edit"</span>, and then the <span className="font-bold">"mirror"</span>. You can make some adjustments with your mandible. 
