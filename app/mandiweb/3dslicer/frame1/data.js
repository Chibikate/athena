...
export const mandiWebData = [
  {
    ...
    image: [Image1],
    description:
      'Load the data by clicking on the "Load DICOM Data" button show in the picture.',
  ...
  },
  {
    key: 5,
    image: [Image5],
    description: `"After loading, your dataset should show in the list as shown above.
    Click the{" "}
  ...
  },
  {
    key: 6,
    image: [Image6],
    description: `"The CT scan files should show up once the DICOM files are done
