...
<div className="flex justify-between mt-8 space-x-4">
      ...
      <div className="space-y-4b bg-[rgba(191,213,247,0.3)] p-8 rounded-lg shadow-md text-center flex items-center">
        <div>
          ...
          <p className="text-justify text-center ml-16 mr-16">
            ...
            the upper left of the toolbar as indicated above.<br/> For the purpose of
...
<div className="flex items-center justify-center py-4">
        ...
        alt="something never " src={image5} width={550} height={550} />
        </div>
        </div>
      </div>
      <div className="flex justify-between mt-8 space-x-4">
