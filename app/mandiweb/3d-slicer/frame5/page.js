      ...
      <div className="space-y-4 bg-primary rounded-lg shadow-lg p-8 text-white text-xl">
        <div className="text-center">
          ...
          <p className="text-justify">
            ...
            the need. If no other modifications are required, feel free to print
            the file as is. Take note though, that the file may be too large or
            may contain errors depending on how well the segmentation was
            performed.
          </p>
          <p className="text-justify">
            But the journey doesn&#34;t end here! 🌟 Continue your adventure in
            the world of developing mandibular reconstruction by taking our 3D
            Quiz before proceeding to meshmixer.
          </p>
        </div>
      </div>
