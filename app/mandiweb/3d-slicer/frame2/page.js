        ...
        <div className="space-y-4b bg-[rgba(191,213,247,0.3)] p-8 rounded-lg shadow-md text-center flex items-center">
          <div>
            <div className="flex flex-col space-y-2 items-center">
              <h3 className="text-2xl font-extrabold mb-4 dark:text-white text-primary">
                3D Slicer Module
              </h3>
...
For the purpose of the tutorial, the modules that users will be using are <span className="font-bold dark:text-white text-primary">Crop Volume</span>, 
<span className="font-bold dark:text-white text-primary"> Segment Editor, </span> and <span className="font-bold dark:text-white text-primary">Volumes Module</span>.
              </p>
            </div>
