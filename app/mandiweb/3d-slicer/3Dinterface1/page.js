    ...
    <div className="flex flex-col min-h-screen overflow-x-hidden  dark:text-white">
      <main className="flex flex-col md:flex md:flex-row items-center justify-between p-14 space-y-4">
        ...
        <div className=" space-y-4 items-center bg-[rgba(191,213,247,0.3)] p-8 rounded-lg shadow-md text-center">
          ...
          <div className="p-2">
            <p className="text-left font-bold text-xl dark:text-white text-primary">Toolbar </p>
            ...
            <p className="text-left pb-2">
              <span className="font-bold dark:text-white text-primary">Module Selection</span>{" "}
              toolbar is used for selecting the currently active &#34;module&#34;. The
              toolbar provides options for searching for module names (
              <span className="font-bold dark:text-white text-primary">ctrl +</span> f or click
              on magnify glass icon) or selecting from a menu.{" "}
              <span className="font-bold dark:text-white text-primary">
                Module history dropdown button
              </span>{" "}
              shows the list of recently used modules.{" "}
              <span className="font-bold dark:text-white text-primary">Arrow buttons</span> can
            ...
            <p className="text-left pb-2">
              <span className="font-bold dark:text-white text-primary">Favorite modules </span>{" "}
          ...
          <p className="text-primary font-bold dark:text-white text-xl text-left">Data Probe</p>
          <p className="text-left pb-2">
          ...
          <p className="text-primary dark:text-white font-bold text-xl text-left">Views</p>
          <p className="text-left pb-2">
