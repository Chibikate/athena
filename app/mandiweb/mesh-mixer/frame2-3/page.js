        ...
        <div className="flex flex-col space-x-4 bg-[rgba(191,213,247,0.3)] p-4 rounded-lg shadow-md text-center">
          <div className="text-center pb-4 mb-4">
            <p className="mt-4 text-justify">
              ...
              the skull. Still, under the <span className="font-bold text-primary">Select</span> menu, click on  &ldquo;<span className="font-bold text-primary">edit</span> as shown below to bring out another
              selection menu and click <span className="font-bold text-primary">&#34;Separate&#34;</span>. A quicker way would be using the hotkey <span className="font-bold text-primary">&#34;Y&#34;</span>. WARNING,
