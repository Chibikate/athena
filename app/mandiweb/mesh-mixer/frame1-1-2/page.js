    ...
    <Progress progress={14.4} size="md"/>
      <main className="flex flex-col md:flex md:flex-row items-center justify-between p-14 space-y-4">
        ...
        <div className="text-center pb-4 mb-4">
            ...
            If after you import the file, the 3D printer bed is shown as well as the gridlines, you can remove <br/>this from the view by navigating at the upper left corner and click <span className="font-bold">&#34;view&#34;</span>.<br/> Then uncheck <span className="font-bold">&#34;Show Grid&#34;</span> and <span className="font-bold">&#34;Show Printer Bed&#34;</span>.
            </p>
          </div>
